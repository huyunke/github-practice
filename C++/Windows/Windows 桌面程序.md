...
| **阶段** | **核心组件**          | **动作**                             |
| ------ | ----------------- | ---------------------------------- |
| **诞生** | `WinMain`         | 初始化，注册并创建窗口。                       |
| **心跳** | **消息循环**          | `GetMessage` 不断从队列里捞东西。            |
| **思考** | `WndProc`         | 根据 `switch-case` 决定如何响应（点火、绘图、按键）。 |
| **辅助** | `DefWindowProc`   | 你不想管的事情，通通丢给这个“管家”。                |
| **告别** | `PostQuitMessage` | 优雅地告诉循环：“戏演完了，可以散场了。”              |
